package com.SecurityPart.SecurityPart.security.jwt;
...
import com.SecurityPart.SecurityPart.service.UserDetailsImple;
...
public class JwtUtils {
    ...
    @Value("${securitypart.app.jwtCookieName}")
    private String jwtCookieName;

    @Value("${securitypart.app.jwtSecret}")
    private String jwtSecret;

    @Value("${securitypart.app.jwtExpirationMs}")
